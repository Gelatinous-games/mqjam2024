...
#define MENU_ELEMENT_PADDING 10

#define DEATH_MENU_BG_COLOUR (Color){160,160,160,85}
...
#define WORMHOLE_TRAVEL_DISTANCE 1000

#define BACKGROUND_OBJECT_COUNT 100

#define BACKGROUND_SPAWN_MAX_DISTANCE_X 100.0f
#define BACKGROUND_SPAWN_MAX_DISTANCE_Y 40.0f
